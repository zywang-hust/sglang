...
def get_batch_sizes_to_capture(
    ...
    # Copy: the `capture_bs += [...]` below must not mutate
    # cuda_graph_config.decode.bs, which is shared across graph runners
    # (target + EAGLE draft both build their capture lists from it).
