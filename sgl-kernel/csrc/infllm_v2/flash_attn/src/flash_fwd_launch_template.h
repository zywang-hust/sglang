...
void run_mha_fwd_hdim64(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
    if constexpr (!Is_dropout) {
      ...
      run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 16, 64, 1, false, false, T>, Is_dropout, Is_causal>(
          params, stream);
      // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, false, T>, Is_dropout, Is_causal>(params,
      // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, true, T>, Is_dropout,
...
void run_mha_fwd_hdim96(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
    ...
    // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, false, T>, Is_dropout, Is_causal>(params,
    // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, true, T>, Is_dropout,
    // Is_causal>(params, stream); These two are always slower run_flash_fwd<Flash_fwd_kernel_traits<96, 128, 128, 4,
    // true, T>>(params, stream); run_flash_fwd<Flash_fwd_kernel_traits<96, 64, 128, 4, true, T>>(params, stream);
  });
}
...
void run_mha_fwd_hdim128(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
    if constexpr (!Is_dropout) {
      ...
      // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, false, T>, Is_dropout, Is_causal>(params,
      // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, true, true, T>, Is_dropout,
      // Is_causal>(params, stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 128, 4, false, false, T>,
      // Is_dropout, Is_causal>(params, stream); Using 8 warps (128 x 128 and 256 x 64) is 28% slower for seqlen=2k
      // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 8, false, false, T>, Is_dropout, Is_causal>(params,
      // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 8, false, false, T>, Is_dropout,
      // Is_causal>(params, stream); 1st ones are good for H100, A100 2nd one is good for A6000 bc we get slightly
      // better occupancy
    } else {
      run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 16, 64, 1, false, false, T>, Is_dropout, Is_causal>(
          params, stream);
      // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 64, 4, false, false, T>, Is_dropout, Is_causal>(params,
      // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 32, 4, true, false, T>, Is_dropout,
      // Is_causal>(params, stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 32, 4, true, true, T>,
      // Is_dropout, Is_causal>(params, stream);
    }
  });
}
...
void run_mha_fwd_hdim160(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
    ...
    // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 32, 4, false, true, T>, Is_dropout, Is_causal>(params,
    // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, false, false, T>, Is_dropout,
    // Is_causal>(params, stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, false, T>>(params,
    // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 128, 4, false, T>>(params, stream);
...
void run_mha_fwd_hdim192(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
    ...
    // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 32, 8, false, false, T>, Is_dropout,
    // Is_causal>(params, stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 64, 4, false, T>>(params,
    // stream); run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 64, 128, 4, false, T>>(params, stream);
    // run_flash_fwd<Flash_fwd_kernel_traits<Headdim, 128, 128, 8, false, T>>(params, stream);
  });
...
void run_mha_fwd_hdim256(Flash_fwd_params& params, cudaStream_t stream) {
  ...
  cudaError status_ = cudaDeviceGetAttribute(&max_smem_per_sm, cudaDevAttrMaxSharedMemoryPerMultiprocessor, device);
  status_ = cudaDeviceGetAttribute(&max_smem_per_block, cudaDevAttrMaxSharedMemoryPerBlockOptin, device);
